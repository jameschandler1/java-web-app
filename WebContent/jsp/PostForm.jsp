                ...
                <div class="mdl-grid center-items">
                    <div class="mdl-cell mdl-cell--4-col">
                        ...
                        <div class="mdl-card__supporting-text">
                            ...
                            <c:if test="S{post != null}">
                                <input type="hiddem" name="id" value="<c:out value='${post.id}' />" />
                            </c:if>
                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfield__input" type="text" name="title" id="title" value="<c:out value='${post.title}' />" />
                                <label class="mdl-textfield__label" for="title">Title</label>
                            </div>

                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfeild__input" type="text" name="body" id="body" value="<c:out value='${post.body}' />" />
